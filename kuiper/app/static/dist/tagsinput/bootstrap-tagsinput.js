function escapeHtml(unsafe) {
  ...
  (function ($) {
    ...
    function TagsInput(element, options) {
      ...
      this.$input = $('<input style="background-color: rgb(57 62 90)" type="text" placeholder="' + this.placeholderText + '"/>').appendTo(this.$container);
    ...
    TagsInput.prototype = {
        ...
        $('.tag', self.$container).each(function() {
          ...
          if(self.objectItems){
              ...
              var $tag = $(this),
                ...
                //  return this.nodeType == 3;
                //})[0].nodeValue = htmlEncode(itemText);
                $tag.contents().filter( function(){return this.nodeType == 3;} )[0].nodeValue = htmlEncode(itemText);
      ...
      // change the tag content, the function take to arguments (old tag , new tag) and change the tag content to the new tag
      change_tag: function(tags){
          ...
          var tagClass = this.options.tagClass(newt);
          // change the container content and class
          $item_container.attr('class', null);
          ...
          var option = $('option', self.$element).filter(function() { return $(this).data('item') === oldt; });
          option.attr('value', newt);
          option.val(newt);
          option.data('item' , newt);
  
          var index = this.itemsArray.indexOf(oldt);
  
          if(index !== -1)
              this.itemsArray[ index ] =  newt;
